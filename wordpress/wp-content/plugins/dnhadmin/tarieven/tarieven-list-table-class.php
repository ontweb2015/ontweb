...
/*******************************************************************************************************
Plugin: DNHAdmin
Script: tarieven-list-table-class.inc.php
Doel  : Klasse die de lijst met tarieven kan renderen
Auteur: BugSlayer
*******************************************************************************************************/
 ...
 */
class DNHTarieven_List_Table extends WP_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            ...
            'plural'    => 'tarieven',  //plural name of the listed records
	...
	function get_data() {
        ...
        return $wpdb->get_results("SELECT * FROM TARIEF ORDER BY Jaar");
	}
	...
	function column_jaar($item) {
        //Build row actions
        $actions = array(
            'edit'      => sprintf( '<a href="?page=%s&%s=%s">%s</a>'  ,'dnh_tarieven_edit'  ,$this->_args['singular'], $item->Jaar, __( 'Edit' ) ),
            'delete'    => sprintf( '<a href="?page=%s&%s=%s">%s</a>','dnh_tarieven_delete',$this->_args['singular'], $item->Jaar, __( 'Delete' ) ),
        );
