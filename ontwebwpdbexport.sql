...
`FactuurId` int(11) NOT NULL,
  ...
  `Datum` date NOT NULL,
  `Lid_LidId` int(11) NOT NULL,
  `Tarief_Begindatum` date NOT NULL
...
`RegelId` int(11) NOT NULL,
  `Omschrijving` varchar(45) NOT NULL,
  `Aantal` int(11) NOT NULL,
  `BedragPerEenheid` double NOT NULL,
  `TotaalBedrag` double NOT NULL,
  `Factuur_FactuurId` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `ligplaats`
--

CREATE TABLE IF NOT EXISTS `ligplaats` (
`LigplaatsNummer` int(11) NOT NULL,
  `Lengte` int(11) NOT NULL,
  `Schip_SchipId` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `schip` (
...
CREATE TABLE IF NOT EXISTS `tarief` (
  ...
  `Contributiebedrag` decimal(10,0) NOT NULL,
  `Energietoeslag` decimal(10,0) NOT NULL,
  `LiggeldLid` decimal(10,0) NOT NULL,
  `LiggeldPassant` decimal(10,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
`TransactieId` int(11) NOT NULL,
  ...
  `Datum` date NOT NULL,
  `Factuur_FactuurId` int(11) DEFAULT NULL,
  `Rubriek_RubriekId` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'siteurl', 'http://localhost/ontweb/wordpress', 'yes'),
(2, 'home', 'http://localhost/ontweb/wordpress', 'yes'),
(3, 'blogname', 'd&#039;n oude haven', 'yes'),
(4, 'blogdescription', 'En nog een WordPress site', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'maaike00@hotmail.com', 'yes'),
...
(97, 'cron', 'a:4:{i:1429901160;a:1:{s:20:"wp_maybe_auto_update";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1429925923;a:3:{s:16:"wp_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:17:"wp_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1429969197;a:1:{s:19:"wp_scheduled_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}s:7:"version";i:2;}', 'yes'),
(100, '_transient_random_seed', 'a560a74982047886424ab311d33f3411', 'yes'),
(103, '_site_transient_timeout_theme_roots', '1429884541', 'yes'),
(104, '_site_transient_theme_roots', 'a:3:{s:13:"twentyfifteen";s:7:"/themes";s:14:"twentyfourteen";s:7:"/themes";s:14:"twentythirteen";s:7:"/themes";}', 'yes'),
(106, '_site_transient_timeout_browser_837ac6e56c8bf9987e4fbaa5079e156e', '1430487542', 'yes'),
...
(111, '_transient_timeout_feed_ac0b00fe65abe10e0c5b588f3ed8c7ca', '1429925945', 'no'),
...
(113, '_transient_timeout_feed_mod_ac0b00fe65abe10e0c5b588f3ed8c7ca', '1429925946', 'no'),
(114, '_transient_feed_mod_ac0b00fe65abe10e0c5b588f3ed8c7ca', '1429882746', 'no'),
(115, '_site_transient_update_plugins', 'O:8:"stdClass":4:{s:12:"last_checked";i:1429883129;s:8:"response";a:0:{}s:12:"translations";a:0:{}s:9:"no_update";a:0:{}}', 'yes'),
(116, '_transient_timeout_feed_d117b5738fbd35bd8c0391cda1f2b5d9', '1429925948', 'no'),
...
(14, 1, 'session_tokens', 'a:1:{s:64:"d032f2ddae492617a77da22cfd00d49326248a88f6504994f09ff6f02753fcdb";a:4:{s:10:"expiration";i:1431092340;s:2:"ip";s:3:"::1";s:2:"ua";s:108:"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.90 Safari/537.36";s:5:"login";i:1429882740;}}'),
...
(1, 'admin', '$P$BMB/MhI9zaRobURhU4D5Ek5DPJ/NnW0', 'admin', 'maaike00@hotmail.com', '', '2015-04-24 13:38:30', '', 0, 'admin');
...
--
ALTER TABLE `factuur`
 ADD PRIMARY KEY (`FactuurId`), ADD KEY `fk_Factuur_Lid1_idx` (`Lid_LidId`), ADD KEY `fk_Factuur_Tarief1_idx` (`Tarief_Begindatum`);

--
-- Indexes for table `factuurregel`
--
ALTER TABLE `factuurregel`
 ADD PRIMARY KEY (`RegelId`), ADD KEY `fk_Factuurregel_Factuur1_idx` (`Factuur_FactuurId`);
...
--
-- Indexes for table `ligplaats`
--
ALTER TABLE `ligplaats`
 ADD PRIMARY KEY (`LigplaatsNummer`), ADD KEY `fk_Ligplaats_Schip_idx` (`Schip_SchipId`);

--
-- Indexes for table `rubriek`
--
ALTER TABLE `rubriek`
 ADD PRIMARY KEY (`RubriekId`);

--
-- Indexes for table `schip`
--
ALTER TABLE `schip`
 ADD PRIMARY KEY (`SchipId`), ADD KEY `fk_Schip_Lid1_idx` (`Lid_LidId`);

--
-- Indexes for table `tarief`
--
ALTER TABLE `tarief`
 ADD PRIMARY KEY (`Begindatum`);

--
-- Indexes for table `transactie`
--
ALTER TABLE `transactie`
 ADD PRIMARY KEY (`TransactieId`), ADD KEY `fk_Transactie_Factuur1_idx` (`Factuur_FactuurId`), ADD KEY `fk_Transactie_Rubriek1_idx` (`Rubriek_RubriekId`);
...
--
ALTER TABLE `factuurregel`
MODIFY `RegelId` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `ligplaats`
--
ALTER TABLE `ligplaats`
MODIFY `LigplaatsNummer` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rubriek`
--
ALTER TABLE `rubriek`
MODIFY `RubriekId` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `schip`
--
ALTER TABLE `schip`
MODIFY `SchipId` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `transactie`
--
ALTER TABLE `transactie`
MODIFY `TransactieId` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `factuur`
ADD CONSTRAINT `fk_Factuur_Lid1` FOREIGN KEY (`Lid_LidId`) REFERENCES `lid` (`LidId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_Factuur_Tarief1` FOREIGN KEY (`Tarief_Begindatum`) REFERENCES `tarief` (`Begindatum`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `factuurregel`
--
ALTER TABLE `factuurregel`
ADD CONSTRAINT `fk_Factuurregel_Factuur1` FOREIGN KEY (`Factuur_FactuurId`) REFERENCES `factuur` (`FactuurId`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `ligplaats`
--
ALTER TABLE `ligplaats`
ADD CONSTRAINT `fk_Ligplaats_Schip` FOREIGN KEY (`Schip_SchipId`) REFERENCES `schip` (`SchipId`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `schip`
--
ALTER TABLE `schip`
ADD CONSTRAINT `fk_Schip_Lid1` FOREIGN KEY (`Lid_LidId`) REFERENCES `lid` (`LidId`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `transactie`
--
ALTER TABLE `transactie`
ADD CONSTRAINT `fk_Transactie_Factuur1` FOREIGN KEY (`Factuur_FactuurId`) REFERENCES `factuur` (`FactuurId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_Transactie_Rubriek1` FOREIGN KEY (`Rubriek_RubriekId`) REFERENCES `rubriek` (`RubriekId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
